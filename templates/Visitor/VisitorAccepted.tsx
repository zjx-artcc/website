...
export const visitorAccepted = (user: User) => {
    return renderReactToMjml(
        <SingleRecipientEmailWrapper recipient={user} headerText="Visitor Application Accepted">
            <p>Congratulations! You have been accepted as a visitor at vZJX.</p>
            ...
            <p>Before you can control at any of our facilities, read our administrative documents and our visitor policy
                in the <a
                    href="https://zjxartcc.org/publications/downloads">publications section</a> of our website.</p>
            <br/>
            <p>You can now access our website to customize <a href="https://zjxartcc.org/profile/overview">your
                profile</a> and <a
                href="https://training.zjxartcc.org">request training.</a></p>
            <br/>
            <p>Regards,</p>
            <p>The vZJX Staff</p>
